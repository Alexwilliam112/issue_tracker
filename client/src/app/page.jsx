...
export default function IssueTracker() {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
      ...
      'Latest Escalation Layer', 'Latest Escalation Status',
        ...
        <div className="overflow-x-auto">
            ...
            <tbody className="divide-y divide-slate-100">
                ...
                >
                    ...
                    <span className="font-semibold text-slate-700 group-hover:text-indigo-600 transition-colors block w-48 truncate">{issue.title}</span>
                    </td>
